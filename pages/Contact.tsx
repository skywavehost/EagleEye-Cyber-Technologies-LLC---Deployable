        ...
        <div className="max-w-md w-full text-center space-y-8 animate-in fade-in zoom-in duration-500">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 font-light leading-relaxed">
              ...
              A Senior Security Architect will review your environment and contact you within 4 hours.
            </p>
          </div>
          <button 
            onClick={() => {
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-6 p-6 bg-[#0a0a0b] border border-white/5 rounded-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed">Our Global Security Operations Center (GSOC) maintains a 4-hour SLA for all audit requests.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="other">Other High-Security Sector</option>
                  </select>
                </div>
              </div>
